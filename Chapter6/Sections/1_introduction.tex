...
Where Chapters~3--5 align learning with pixel-grounded entities and relations, Chapters~6--7 align it with the correspondence between a generated target and its references. These structures are not interchangeable, but they play the same functional role: each specifies the relationships that learning must preserve to satisfy the task.
