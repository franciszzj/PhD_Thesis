...
Chapter~6 opens the controllable-generation part of the thesis.
After Chapters~3--5 focused on structured understanding, the thesis now turns to faithful reference-preserving generation.
The specific question in this chapter is how a diffusion model can preserve fine-grained reference details in a single generated image before Chapter~7 extends the same problem to videos.
