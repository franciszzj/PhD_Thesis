...
Chapter~3 opens the structured-understanding part of the thesis by addressing the first major limitation of panoptic scene graph generation: reliable relation prediction under long-tail bias.
The goal of this chapter is to establish a strong closed-set PSG formulation that can recover both common and rare predicates before the later chapters add language priors and open-set capability.
...
Subjects and objects are represented with panoptic segmentation~\cite{kirillov2019panoptic} masks. Unless stated otherwise, the structured-understanding chapters of this thesis focus on PSG, since it is pixel-level accurate and also covers background classes and their relations with foreground objects.
