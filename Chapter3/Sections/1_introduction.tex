...
Subjects and objects are represented with panoptic segmentation~\cite{kirillov2019panoptic} masks. Unless stated otherwise, in this chapter we focus on PSG, since it is pixel-level accurate and also covers background classes and their relations with foreground objects.
