...
They are not combined in the paper, but we can simply fuse their outputs using the inference fusion method in \cite{zhou2023hilo, zhou2023vlprompt}, the results in Tab.~\ref{tab:rebuttal_psg} (fuse G and J) show slight improvement (+0.5\% in R@100) but also come with double computation cost.
