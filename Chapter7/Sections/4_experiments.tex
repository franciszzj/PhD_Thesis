...
\centering
\caption{
\textbf{Quantitative results on the OpenS2V-Eval~\citep{yuan2025opens2v} benchmark.}
...
\begin{figure*}[t]
    ...
    \includegraphics[width=1.0\linewidth]{figures/visualization_opens2v_eval.pdf}
    \vspace{-6mm}
    \caption{
    \textbf{Qualitative comparison with existing R2V methods.}
...
We further conduct a qualitative comparison between Saber and other methods (Kling1.6~\citep{kling}, Phantom~\citep{liu2025phantom} and VACE~\citep{jiang2025vace}) across various visual scenarios, as shown in Fig.~\ref{saber:fig:vis_opens2v_eval}.
...
\paragraph{The Effect of Masked Training.}
...
\paragraph{The Effect of Mask Generator.}
...
\begin{wrapfigure}{r}{0.5\textwidth}
    ...
    \includegraphics[width=1.0\linewidth]{figures/ablation_mask_aug.pdf}
    \vspace{-6mm}
    \caption{
    \textbf{Effect of mask augmentation.}
...
\paragraph{The Effect of Mask Augmentation.}
...
\paragraph{The Effect of the Attention Mask.}
...
\begin{figure}[h]
    \centering
    % \fbox{\rule{0pt}{8.5in} \rule{1.0\linewidth}{0pt}}
    \includegraphics[width=1.0\linewidth]{figures/ablation_attn_mask_arxiv.pdf}
    \vspace{-6mm}
    \caption{
    \textbf{Effect of the attention mask.}
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    % \fbox{\rule{0pt}{8.5in} \rule{1.0\linewidth}{0pt}}
    \includegraphics[width=1.0\linewidth]{figures/one_subject_multi_view.pdf}
    \vspace{-6mm}
    \caption{
    \textbf{Qualitative results on multiple reference images of the same subject.}
...
\paragraph{Single Subject Multiple Views.}
...
\begin{figure}[h]
    \centering
    % \fbox{\rule{0pt}{8.5in} \rule{1.0\linewidth}{0pt}}
    \includegraphics[width=1.0\linewidth]{figures/cross_modal_alignment_arxiv.pdf}
    \vspace{-6mm}
    \caption{
    \textbf{Qualitative results of cross-modal alignment between reference images and text prompts.}
