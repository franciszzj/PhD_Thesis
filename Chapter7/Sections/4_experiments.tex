...
\begin{wrapfigure}{r}{0.5\textwidth}
    ...
    \includegraphics[width=1.0\linewidth]{Chapter7/Figures/ablation_mask_aug.pdf}
    \caption{
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    % \fbox{\rule{0pt}{8.5in} \rule{1.0\linewidth}{0pt}}
    \includegraphics[width=1.0\linewidth]{Chapter7/Figures/one_subject_multi_view.pdf}
    \caption{
