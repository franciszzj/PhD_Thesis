...
Building on the reference-preservation problem studied in Chapter~6, this chapter asks how the same idea can scale from single images to videos.
The challenge is not only to preserve identity from references, but also to maintain that identity over time without relying on costly reference image--video--text triplets.
