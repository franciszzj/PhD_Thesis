...
Building on Chapter~3, this chapter addresses a second limitation of PSG: rare and ambiguous relations are often difficult to resolve from visual evidence alone.
The setting remains closed-set PSG, but the goal now is to enrich grounded relation prediction with language priors before Chapter~5 moves to open-set relation prediction.
