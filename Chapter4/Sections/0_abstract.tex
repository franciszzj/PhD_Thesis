...
To this end, we propose the \textbf{V}ision-\textbf{L}anguage \textbf{Prompt}ing (\textbf{VLPrompt}) model, which acquires vision information from images and language information from LLMs.
...
Code is available at \url{https://github.com/franciszzj/VLPrompt}.
