\noindent This appendix provides more details about the RP- and RJ-prompts along with the corresponding descriptions output by the LLMs.
...
As shown in 
Tab.~\ref{vlprompt:tab:ablation_language_feature_extractor} 
% Tab.~4
of this chapter, models trained using descriptions from Llama3-8B are only 0.5\% lower in mR@100 compared to those using GPT-4.
